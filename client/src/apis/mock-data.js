...
export const mockData = {
  board: {
    ...
    columns: [
      ...
      //xu ly bug logic thu vien dnd-kit khi column la rong
      //phia FE se tu tao ra mot card dat biet: placehoder card, khong lien quan toi back-end
      //card dat biet nay se bi an o giao dien UI nguoi dung
      //cau truc id cua card nay rat don gian khong phai lam random phuc tap
      // columnId-plcaeholder-card (moi column chi co toi da mot placeholder card)
      {
        _id: 'column-id-04',
        boardId: 'board-id-01',
